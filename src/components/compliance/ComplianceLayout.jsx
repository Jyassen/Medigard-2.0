    ...
    <footer className="py-16 border-t border-white/5 bg-[#0a1a14] mt-auto">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="text-xs text-zinc-500 max-w-2xl mx-auto leading-relaxed mb-6">
          ...
          this compliance funnel and the services described herein. References
          to &quot;Medigard&quot; refer to Medigard Compliance Systems LLC.
        </p>
        <p className="text-[10px] text-zinc-600 max-w-2xl mx-auto leading-relaxed uppercase tracking-widest">
          Medigard is an independent compliance automation provider. We are not
          affiliated with CMS or any government agency. Our system is designed
          to assist with compliance monitoring but does not guarantee legal
          immunity.
        </p>
