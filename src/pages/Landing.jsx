...
export default function Landing() {
  ...
  const bookingSrc = withSource(
    BOOKING_URLS.compliance,
    CRM_SOURCES.complianceBook,
  );
  ...
  const pillars = [
    {
      ...
      bgIcon: (
        <svg
          className="absolute right-4 bottom-4 w-32 h-32 text-blue-500/10"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
    ...
    },
    {
      ...
      bgIcon: (
        <svg
          className="absolute right-4 bottom-4 w-32 h-32 text-purple-500/10"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
    ...
    },
    {
      ...
      bgIcon: (
        <svg
          className="absolute right-4 bottom-4 w-32 h-32 text-emerald-500/10"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
    ...
    },
    {
      ...
      bgIcon: (
        <svg
          className="absolute right-4 bottom-4 w-32 h-32 text-orange-500/10"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
    ...
    <div className="min-h-screen bg-white font-['Inter'] text-slate-900">
      ...
      <section className="pt-24 pb-20 px-6">
        <div className="container mx-auto max-w-6xl text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-[#1e293b] mb-8 leading-[1.1] tracking-tight max-w-5xl mx-auto">
            One Missed Violation Costs $250K.
            <br />
            <span className="text-[#3b82f6]">
              We Monitor the 95% of Calls You Don't.
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-slate-500 mb-12 max-w-3xl mx-auto leading-relaxed font-medium">
            Automated call monitoring, real-time violation detection, and
            audit-ready proof — deployed in 30 days.
          </p>

          <div id="vsl" className="max-w-2xl mx-auto mb-16 mt-16">
            <VslPlayer
              title="How to Automate 100% of Medicare Compliance in 30 Days"
              wistiaId="0pdsraeq1g"
              wistiaAspect="1.0"
            />
          </div>
          ...
          <div id="booking" className="max-w-4xl mx-auto mb-32 scroll-mt-8">
            ...
            <p className="text-xl text-slate-500 font-medium leading-relaxed max-w-2xl mx-auto mb-10">
              Select a time for your 30-minute technical strategy session. We'll
              map your blind spots and calculate your penalty exposure.
            </p>
            <div className="rounded-[2.5rem] overflow-hidden bg-white border border-slate-100 shadow-xl shadow-blue-500/5">
              {canEmbedBooking(BOOKING_URLS.compliance) ? (
                <BookingWidget
                  src={bookingSrc}
                  title="Schedule a Medigard compliance audit"
                  thankYouTo={HUB_THANK_YOU}
                />
              ) : (
                <a
                  className="inline-block px-10 py-5 rounded-xl text-lg font-bold bg-[#3b82f6] text-white"
                  href={bookingSrc}
                  target="_blank"
                  rel="noreferrer"
                >
                  Open compliance audit calendar
                </a>
              )}
            </div>
          </div>
          ...
          <div className="py-24 border-t border-slate-100">
            <div className="text-center mb-16">
              ...
              <h2 className="text-5xl md:text-6xl font-black text-[#1e293b] mb-6 tracking-tight">
                This Is For You If...
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: "You're losing sleep over the 95% of calls you never hear and the looming CMS audit cycle.",
                },
                {
                  title: "QA Managers",
                  desc: "Your team is drowning in manual reviews and you know hiring more staff isn't the scalable answer.",
                },
                {
                  title: "Agency Owners",
                  desc: "You need to protect millions in override revenue and carrier contracts from a single violation.",
                },
                {
                  title: "TPMO Leaders",
                  desc: "You want to scale your agent count without exponentially increasing your regulatory risk profile.",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="bg-blue-100/60 p-8 rounded-3xl border border-blue-200 shadow-sm"
                >
                  <h3 className="text-xl font-black text-[#1e293b] mb-3">
                    {item.title}
                  </h3>
          ...
          <div className="py-24 border-t border-slate-100">
            <div className="text-center mb-16">
              ...
              <p className="text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto font-medium">
                Here's what most Medicare organizations are still doing and why
                it quietly sabotages their success:
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="bg-blue-100/40 p-10 rounded-3xl border border-blue-200 shadow-sm hover:shadow-md transition-shadow text-left"
                >
                  <h4 className="text-2xl font-black text-[#1e293b] mb-4 tracking-tight">
                    "{item.q}"
                  </h4>
          ...
          <div className="py-24 border-t border-slate-100 bg-white">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="text-left">
                <h2 className="text-5xl font-black text-[#1e293b] mb-8 tracking-tight">
                  The Manual Trap vs. <br />
                  <span className="text-blue-600">The Command System</span>
                </h2>
                <p className="text-xl text-slate-600 mb-8 font-medium">
                  Most agencies are using 2015 processes for 2025 enforcement
                  levels. It's a recipe for disaster.
                </p>
                <div className="space-y-6">
                  <div className="p-6 bg-red-50 rounded-2xl border border-red-100">
                    <h4 className="text-red-600 font-black uppercase tracking-widest text-xs mb-3">
                  ...
                  <div className="p-6 bg-emerald-50 rounded-2xl border border-emerald-100">
                    <h4 className="text-emerald-600 font-black uppercase tracking-widest text-xs mb-3">
                      The New Way (Medigard)
                    </h4>
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-blue-600 text-white p-8 rounded-3xl shadow-xl max-w-xs text-left overflow-hidden">
                  <div className="relative z-10">
                    ...
                    <p className="text-sm font-bold opacity-90 uppercase tracking-widest leading-tight">
                      Increase in CMS Enforcement Actions YoY
                    </p>
                  </div>
                  {/* Decorative Chart Background */}
                  <svg
                    className="absolute bottom-0 right-0 w-32 h-16 text-white/10 -mb-2"
                    viewBox="0 0 100 40"
                    preserveAspectRatio="none"
                  >
                    <path
                      d="M0 40 L20 30 L40 35 L60 15 L80 20 L100 0 L100 40 Z"
                      fill="currentColor"
                    />
                  </svg>
                </div>
          ...
          <div id="solution" className="py-24 border-t border-slate-100">
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-black text-[#1e293b] mb-6 leading-tight">
              The Medigard Compliance <br />
              <span className="text-blue-600">Command System™</span>
            </h2>
            <p className="text-xl md:text-2xl text-slate-500 mb-16 max-w-2xl mx-auto font-medium">
              Stop thinking about compliance as a department. Think about it as
              infrastructure.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
              {pillars.map((pillar, i) => (
                <div
                  key={i}
                  className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-500 text-left relative overflow-hidden group"
                >
                  {pillar.bgIcon}
                  <div className="relative z-10">
                    <div
                      className={`w-14 h-14 ${pillar.bgColor} rounded-2xl flex items-center justify-center mb-8 shadow-inner border border-slate-100 group-hover:scale-110 transition-transform`}
                    >
                      <div className={pillar.color}>{pillar.icon}</div>
                    </div>
                    <h3 className="text-3xl md:text-4xl font-black text-[#1e293b] mb-2">
                      {pillar.title}
                    </h3>
                    <p className="text-[10px] md:text-xs font-black text-slate-400 uppercase tracking-[0.25em] mb-6">
                      {pillar.tagline}
                    </p>
          ...
          <div className="py-24 border-y border-slate-100">
            <div className="text-center mb-16">
              <h2 className="text-5xl font-black text-[#1e293b] mb-6 tracking-tight">
                Your Infrastructure Walkthrough
              </h2>
              <p className="text-xl text-slate-500 font-medium">
                A focused 30-minute session to map your path to 100% compliance.
              </p>
            </div>
              ...
              {[
                {
                  step: "1",
                  title: "Gap Audit",
                  desc: "We analyze your current call volume vs. QA capacity to find your 'Blind Spot' percentage.",
                },
                {
                  step: "2",
                  title: "Risk Mapping",
                  desc: "We calculate your potential penalty exposure based on current CMS enforcement trends.",
                },
                {
                  step: "3",
                  title: "System Demo",
                  desc: "A live look at how the 4 Pillars would integrate with your existing call infrastructure.",
                },
                {
                  step: "4",
                  title: "30-Day Roadmap",
                  desc: "A step-by-step plan to get you fully deployed and audit-ready in exactly one month.",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="relative bg-blue-100/40 p-8 rounded-3xl border border-blue-200 shadow-sm"
                >
                  <span className="text-6xl font-black text-blue-600/10 absolute -top-8 -left-2 z-0">
                    {item.step}
                  </span>
                  <div className="relative z-10">
                    <h3 className="text-xl font-black text-[#1e293b] mb-3">
      ...
      <section className="py-24 bg-white px-6">
        <div className="container mx-auto max-w-3xl">
          <h2 className="text-5xl font-black text-[#1e293b] mb-12 text-center tracking-tight">
            ...
            {[
              {
                ...
                a: "Most systems are just tools that require your team to do the work. Medigard is infrastructure. We build it, configure it, and deploy it so it works for you automatically.",
              },
              {
                q: "Is this HIPAA compliant?",
                a: "Yes. Our system is built with enterprise-grade security and is fully HIPAA ready, ensuring all beneficiary data is protected and stored according to federal standards.",
              },
              {
                q: "How long does deployment actually take?",
                a: "We guarantee a 30-day white-glove deployment. From the moment we start, you will be monitoring 100% of your calls in exactly one month.",
              },
              {
                q: "Is this a sales call?",
                a: "No. The walkthrough is a technical strategy session where we map your current blind spots and show you exactly what the fix looks like for your specific agency.",
              },
            ].map((faq, i) => (
              <div
                key={i}
      ...
      <HomeOptIn
        eyebrow="Get Started"
        heading="Ready to See Your Blind Spots?"
        subtext="Fill out the form below and we'll get your walkthrough scheduled."
        submitLabel="Get Started"
        source="landing_bottom_opt_in"
        sectionClass="py-24 px-6 bg-gradient-to-b from-blue-50/40 to-white border-t border-slate-100"
        containerClass="max-w-2xl"
        headingClassName="text-4xl md:text-5xl font-black text-[#1e293b] mb-4 tracking-tight"
        subtextClassName="text-xl text-slate-500 font-medium mb-10 leading-relaxed"
      />
