...
export default function ThankYou() {
  ...
  const dest = resolveBookingThankYouPath({
    search,
    storedFunnel: readStoredFunnel(),
  });
  if (dest !== pathname) {
      ...
      <div className="py-16 px-6">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-slate-500 mb-12 font-medium max-w-2xl mx-auto leading-relaxed">
            Your audit session has been booked. Watch the pre-call briefing
            below so we can hit the ground running.
          </p>
          ...
          <div className="max-w-3xl mx-auto mb-20 text-left">
            <VslPlayer
              kicker="Important"
              title="Watch This Before Our Audit Session"
              wistiaId="shurnk5iir"
            />
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left mb-16">
            {[
              {
                title: "Check Inbox",
                desc: "We've sent a confirmation email with your unique meeting link.",
              },
              {
                title: "Add Calendar",
                desc: "Add the session to your calendar to ensure you don't miss the slot.",
              },
              {
                title: "Invite Team",
                desc: "Forward the invite to your Compliance or Operations leads.",
              },
            ].map((item, i) => (
              <div
                key={item.title}
